	...
	: MyPanel(p)
{
	...
	ui.attack_Text->setText(QString::fromStdWString(guiList[GN_CP_D_ATT]) + QString(":"));
	ui.defense_Text->setText(QString::fromStdWString(guiList[GN_CP_D_DEF]) + QString(":"));
	ui.magic_Text->setText(QString::fromStdWString(guiList[GN_CP_D_MAG]) + QString(":"));
	ui.magicDef_Text->setText(QString::fromStdWString(guiList[GN_CP_D_MDEF]) + QString(":"));
	ui.speed_Text->setText(QString::fromStdWString(guiList[GN_CP_D_SPD]) + QString(":"));
	ui.luck_Text->setText(QString::fromStdWString(guiList[GN_CP_D_LUCK]) + QString(":"));
	ui.evade_Text->setText(QString::fromStdWString(guiList[GN_CP_D_EVA]) + QString(":"));
	ui.hit_Text->setText(QString::fromStdWString(guiList[GN_CP_D_HIT]) + QString(":"));
	ui.hp_Text->setText(QString::fromStdWString(guiList[GN_CP_D_HP]) + QString(":"));
	ui.mp_Text->setText(QString::fromStdWString(guiList[GN_CP_D_MP]) + QString(":"));
	ui.curAP_Text->setText(QString::fromStdWString(guiList[GN_CP_D_AP]) + QString(":"));
	ui.AP_got_till_next_lvl_Text->setText(QString::fromStdWString(guiList[GN_CP_D_AP_N]) + QString(":"));
	ui.overdrive_Text->setText(QString::fromStdWString(guiList[GN_CP_D_OD]) + QString(":"));
	ui.s_lv_Text->setText(QString::fromStdWString(guiList[GN_CP_D_SLV]) + QString(":"));
	ui.battles_Text->setText(QString::fromStdWString(guiList[GN_CP_D_BAT]) + QString(":"));
	ui.enemys_Text->setText(QString::fromStdWString(guiList[GN_CP_D_KILL]) + QString(":"));
	ui.deaths_Text->setText(QString::fromStdWString(guiList[GN_CP_D_DEATH]) + QString(":"));
	ui.overdrive_modes_Text->setText(QString::fromStdWString(guiList[GN_CP_D_OD_M]) + QString(":"));
	ui.overdrive_warrior_Text->setText(QString::fromStdWString(guiList[GN_CP_D_WAR]) + QString(":"));
	ui.overdrive_comrade_Text->setText(QString::fromStdWString(guiList[GN_CP_D_COM]) + QString(":"));
	ui.overdrive_healer_Text->setText(QString::fromStdWString(guiList[GN_CP_D_HEAL]) + QString(":"));
	ui.overdrive_tactician_Text->setText(QString::fromStdWString(guiList[GN_CP_D_TAC]) + QString(":"));
	ui.overdrive_victim_Text->setText(QString::fromStdWString(guiList[GN_CP_D_VICM]) + QString(":"));
	ui.overdrive_dancer_Text->setText(QString::fromStdWString(guiList[GN_CP_D_DANC]) + QString(":"));
	ui.overdrive_avenger_Text->setText(QString::fromStdWString(guiList[GN_CP_D_AVEN]) + QString(":"));
	ui.overdrive_slayer_Text->setText(QString::fromStdWString(guiList[GN_CP_D_SLAY]) + QString(":"));
	ui.overdrive_hero_Text->setText(QString::fromStdWString(guiList[GN_CP_D_HERO]) + QString(":"));
	ui.overdrive_rook_Text->setText(QString::fromStdWString(guiList[GN_CP_D_ROOK]) + QString(":"));
	ui.overdrive_victor_Text->setText(QString::fromStdWString(guiList[GN_CP_D_VIC]) + QString(":"));
	ui.overdrive_coward_Text->setText(QString::fromStdWString(guiList[GN_CP_D_COW]) + QString(":"));
	ui.overdrive_ally_Text->setText(QString::fromStdWString(guiList[GN_CP_D_ALLY]) + QString(":"));
	ui.overdrive_sufferer_Text->setText(QString::fromStdWString(guiList[GN_CP_D_SUF]) + QString(":"));
	ui.overdrive_daredevil_Text->setText(QString::fromStdWString(guiList[GN_CP_D_DARE]) + QString(":"));
	ui.overdrive_solo_Text->setText(QString::fromStdWString(guiList[GN_CP_D_SOLO]) + QString(":"));
